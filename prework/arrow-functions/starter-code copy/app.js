...
//  this here refered to the constractor function objects.

// 2. What is "this" when joe.scopeArrow() is invoked?

// this here refered to the prototype of the constructor that is declared globally meaning the scope of 'this' will be global scope object (window).

// 3. Explain why "this" is different when an arrow function is used.

// Arrow functions is a scoped functions meaning that they consider every 'this' to the scope where they are declared. So if arrow function was inside the constructor, 'this' will refer to the constructor objects.
