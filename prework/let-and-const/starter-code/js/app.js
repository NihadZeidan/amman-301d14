...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT : when we use a const to declar a variable locally you will not be allowed use the variable globaly but var let you do that .
